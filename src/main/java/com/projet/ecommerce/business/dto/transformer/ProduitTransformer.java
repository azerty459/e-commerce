...
public class ProduitTransformer {
    ...
    public static ProduitDTO entityToDto(Produit produit) {
        ...
        produitDTO.setCaracs(new ArrayList<>(CaracteristiqueTransformer.listEntityToDto(produit.getCaracs())));
    ...
    public static Produit dtoToEntity(ProduitDTO produitDTO) {
        ...
        produit.setCaracs(new ArrayList<>(CaracteristiqueTransformer.listDtoToEntity(produitDTO.getCaracs())));
        return produit;
    }
}
