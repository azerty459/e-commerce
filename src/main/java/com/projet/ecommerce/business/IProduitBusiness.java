...
public interface IProduitBusiness {
     ...
     */
    ProduitDTO add(String referenceProduit, String nom, String description, float prixHT, List<Integer> nouvelleCat, List<CaracteristiqueDTO> caracteristiquesDTO);
